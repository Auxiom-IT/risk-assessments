      ...
      <div className='dkim-modal'>
        ...
        <div className='dkim-modal-body'>
          <div className='dkim-info-banner'>
            ...
            >
              <path
                d='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2z m0-4h-2V7h2v6z'
              />
            </svg>
            <p>
          ...
          {selectors.length > 0 && (
            <div className='dkim-selectors-section'>
              <h4>{t('dkimModal.currentSelectors')} ({selectors.length})</h4>
