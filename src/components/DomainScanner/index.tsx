...
const DomainScanner = () => {
  ...
  // ✅ Defensive: domainScanAggregate.issues is sometimes missing
        ...
        {domainScanAggregate && (
          <div className='aggregate'>
            ...
            <div className='aggregate-info'>
              ...
              <p>
                <strong>{t('domainScanner.timestamp')}</strong> {new Date(domainScanAggregate.timestamp).toLocaleString()}
              </p>
            </div>

            {/* ✅ Use defensive aggregateIssues instead of domainScanAggregate.issues */}
            <h5>
